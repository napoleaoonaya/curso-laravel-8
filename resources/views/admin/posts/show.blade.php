...
<h1 class="text-center text-3x1 uppercase font-black my-4">Detalhes {{ $post->title }} </h1>
...
<form action="{{ route('posts.destroy', $post->id)}}" method="post">
    ...
    <button class="mr-5 bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-2 px-6 rounded-lg" type="submit">Deletar o : {{ $post->title }}</button>
</form>
